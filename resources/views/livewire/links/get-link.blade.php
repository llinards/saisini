                        ...
                        <table class="text-surface min-w-full text-left text-sm">
                            ...
                            @foreach ($links as $link)
                                <tr class="border-b border-neutral-200">
                                    ...
                                    <td class="flex content-center whitespace-nowrap px-6 py-4">
                                        <a
                                            class="pr-2 text-blue-500 underline hover:text-blue-700"
